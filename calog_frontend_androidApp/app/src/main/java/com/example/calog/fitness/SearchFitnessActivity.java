...
public class SearchFitnessActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        return super.onOptionsItemSelected(
                membership.membershipStatus(item, SearchFitnessActivity.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fitnessMenu = findViewById(R.id.fitnessMenu);
        fitnessMenu.setText("Fitness");
        connect();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                navigation.bottomNavigation(item, SearchFitnessActivity.this, strUserId, txtDate);
                return true;
            }
        });
    ...
    public void connect() {
        ...
        /**
         * Show fitness menu list from the database
         */
        Call<List<FitnessMenuVO>> fitnessMenuList = rs.fitnessMenuList();
        fitnessMenuList.enqueue(new Callback<List<FitnessMenuVO>>() {
            @Override
            public void onResponse(Call<List<FitnessMenuVO>> call, Response<List<FitnessMenuVO>> response) {
                array = response.body();
                adapter = new SearchFitnessAdapter(SearchFitnessActivity.this, array, fitnessDate, str_user_id);
                list.setAdapter(adapter);
            }

            @Override
            public void onFailure(Call<List<FitnessMenuVO>> call, Throwable t) {
                System.out.println("=====SearchFitnessActivity weightList onFailure: " + t.toString());
